import { getAllRecordRequestsToSchedule } from './helpers/databasehelperv2'
...
async function handleFunc(youtuber:string){
...
module.exports.handler = async (event:any):Promise<APIGatewayProxyResult> => {
    ...
    const message:any = JSON.parse(event.Records[0].body);
