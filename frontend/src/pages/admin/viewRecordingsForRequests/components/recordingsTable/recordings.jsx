        ...
        {filteredRecordings.map((recording) => (
          ...
          >
            <div className="flex text-center items-center">
              ...
              {recording.status !== "done" && recording.status !== "completed" && (
              ...
              <div className={recording.status == "done" || recording.status == "completed" ? 'btn px-1 py-1 bg-green-600 mx-2 rounded-md text-black' : 'animae animate-pulse btn px-1 py-1 bg-red-600 mx-2 rounded-md text-white'}>
                status:{recording.status}
              </div>

              {recording.status == "done"  && <div>
